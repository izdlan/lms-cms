...
class StudentLecturerAuthController extends Controller
{
    public function showLoginForm()
    {
        return view('auth.student-lecturer-login');
    }

    public function login(Request $request)
    {
        $request->validate([
            'login_type' => 'required|in:student,lecturer',
    ...
    public function logout(Request $request)
    {
        ...
        return redirect()->route('student-lecturer.login');
    }
}
