        ...
        <div class="row g-0">
            ...
            <div class="main-content">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">
                            <i class="fas fa-list text-primary"></i> Existing Diploma PLOs ({{ $plos->count() }})
                        </h5>
                    </div>
                    <div class="card-body">
                        @forelse($plos as $plo)
                        ...
                        @empty
                            <div class="text-center py-4">
                                <i class="fas fa-mortarboard fa-2x text-muted mb-3"></i>
                                <h6 class="text-muted">No Diploma PLOs found</h6>
                                <p class="text-muted">Add your first Diploma PLO using the form above.</p>
                            </div>
                        @endforelse
                    </div>
                </div>
