...
@section('title', 'PhD PLO Management - ' . $program->name . ' | Admin | Olympia Education')
        ...
        <div class="row g-0">
            ...
            <div class="main-content">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h1>PhD Program Learning Outcomes (PLOs)</h1>
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <h5 class="mb-0">
                            <i class="fas fa-plus-circle text-danger"></i> Add New PhD PLO
                        </h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.programs.store-plo', $program) }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label for="original_research" class="form-label">Original Research</label>
                                        <textarea class="form-control" id="original_research" name="original_research" rows="2" 
                                                  placeholder="Original research contribution..."></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="advanced_research_methods" class="form-label">Advanced Research Methods</label>
                                        <textarea class="form-control" id="advanced_research_methods" name="advanced_research_methods" rows="2" 
                                                  placeholder="Advanced research methodology..."></textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="theoretical_contribution" class="form-label">Theoretical Contribution</label>
                                        <textarea class="form-control" id="theoretical_contribution" name="theoretical_contribution" rows="2" 
                                                  placeholder="Theoretical contribution to field..."></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="publication_requirements" class="form-label">Publication Requirements</label>
                                        <textarea class="form-control" id="publication_requirements" name="publication_requirements" rows="2" 
                                                  placeholder="Publication and dissemination requirements..."></textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="supervision_skills" class="form-label">Supervision Skills</label>
                                        <textarea class="form-control" id="supervision_skills" name="supervision_skills" rows="2" 
                                                  placeholder="Ability to supervise others..."></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-3">
                                        <label for="dissertation_defense" class="form-label">Dissertation Defense</label>
                                        <textarea class="form-control" id="dissertation_defense" name="dissertation_defense" rows="2" 
                                                  placeholder="Dissertation defense requirements..."></textarea>
                                    </div>
                                </div>
                            </div>
                        </form>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">
                            <i class="fas fa-list text-danger"></i> Existing PhD PLOs ({{ $plos->count() }})
                        </h5>
                    </div>
                    <div class="card-body">
                        @forelse($plos as $plo)
                            <div class="border rounded p-3 mb-3">
                                <div class="d-flex justify-content-between align-items-start mb-2">
                                    <div>
                                        <h6 class="mb-1">
                                            <span class="badge bg-danger me-2">{{ $plo->plo_code }}</span>
                                ...
                                @if($plo->original_research)
                                    <div class="mt-2">
                                        <small class="text-muted">
                                            <strong>Original Research:</strong> {{ $plo->original_research }}
                                        </small>
                                    </div>
                                @endif
                                @if($plo->advanced_research_methods)
                                    <div class="mt-2">
                                        <small class="text-muted">
                                            <strong>Advanced Research Methods:</strong> {{ $plo->advanced_research_methods }}
                                        </small>
                                    </div>
                                @endif
                                @if($plo->theoretical_contribution)
                                    <div class="mt-2">
                                        <small class="text-muted">
                                            <strong>Theoretical Contribution:</strong> {{ $plo->theoretical_contribution }}
                                        </small>
                                    </div>
                                @endif
                                @if($plo->publication_requirements)
                                    <div class="mt-2">
                                        <small class="text-muted">
                                            <strong>Publication Requirements:</strong> {{ $plo->publication_requirements }}
                                        </small>
                                    </div>
                                @endif
                                @if($plo->supervision_skills)
                                    <div class="mt-2">
                                        <small class="text-muted">
                                            <strong>Supervision Skills:</strong> {{ $plo->supervision_skills }}
                                        </small>
                                    </div>
                                @endif
                                @if($plo->dissertation_defense)
                                    <div class="mt-2">
                                        <small class="text-muted">
                                            <strong>Dissertation Defense:</strong> {{ $plo->dissertation_defense }}
                                        </small>
                                    </div>
                                @endif
                            </div>
                        @empty
                            <div class="text-center py-4">
                                ...
                                <h6 class="text-muted">No PhD PLOs found</h6>
                                <p class="text-muted">Add your first PhD PLO using the form above.</p>
                            </div>
                        @endforelse
                    </div>
                </div>
