                        ...
                        <form action="{{ route('admin.students.store') }}" method="POST">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('ic') is-invalid @enderror" 
                                               id="ic" name="ic" value="{{ old('ic') }}" required>
                                        @error('ic')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('previous_university') is-invalid @enderror" 
                                               id="previous_university" name="previous_university" value="{{ old('previous_university') }}" 
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('col_ref_no') is-invalid @enderror" 
                                       id="col_ref_no" name="col_ref_no" value="{{ old('col_ref_no') }}" 
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('courses') is-invalid @enderror" 
                                       id="courses" name="courses" value="{{ old('courses') }}" 
                            ...
                            <div class="alert alert-info">
                                ...
                                <strong>Note:</strong> The student's password will be set to their IC number. They can change it after logging in.
                            </div>
