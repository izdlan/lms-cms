                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-4">
                            <div class="footer-links text-md-end d-flex flex-column">
                                ...
                                <a href="{{ route('admin.students') }}" class="text-white-50">
                                    <i data-feather="users" width="14" height="14" class="me-1"></i>
                                    Students
                                </a>
                                <a href="{{ route('admin.import') }}" class="text-white-50">
                                    <i data-feather="upload" width="14" height="14" class="me-1"></i>
                                    Import
                                </a>
                                <div class="footer-version mt-2">
                                    <span class="text-white-50" style="font-size: 0.8rem;">LMS Admin Panel v1.0</span>
                                </div>
                            </div>
                        </div>
                    </div>
