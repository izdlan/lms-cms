                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-text mt-2">Use this section to enter results without JSON or Excel. Rows will be grouped by year and semester automatically.</div>
                                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        rows.forEach(tr => {
            ...
            if (!rec.code && !rec.name) return; // skip empty rows
        ...
        // Always attach hidden field (even if empty) so server can clear or update
